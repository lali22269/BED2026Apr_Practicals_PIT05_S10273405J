...
app.put("/books/:id", validateBookId, validateBook, bookController.updateBook); // Example for PUT route
app.delete("/books/:id", validateBookId, bookController.deleteBook); // Example for DELETE route
// Start server
app.listen(port, () => {
